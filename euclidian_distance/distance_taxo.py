...
bit_file = '../datasets/Outex_taxo.csv'
...
plt.savefig(output_path+'output_taxo.png', bbox_inches='tight',pad_inches = 1)  #to save an image containing all the outputs
img_color = cv2.imread(output_path+'output_taxo.png', 1)  # 1: Color image. 1 is optional.
