...
bit_file = '../datasets/Crc_taxo.csv'
...
plt.savefig(output_path+'crc_taxo.png', bbox_inches='tight',pad_inches = 1)  #to save an image containing all the outputs
img_color = cv2.imread(output_path+'crc_taxo.png', 1)  # 1: Color image. 1 is optional.
