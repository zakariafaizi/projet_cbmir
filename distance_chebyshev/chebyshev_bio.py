...
def get_neighbors(train, test_row, num_neighbors):
    ...
    for train_row in train:
        dist = distance.chebyshev(test_row, pd.to_numeric(train_row[1:7]))
...
plt.savefig(output_path+'chebyshev_bio.png', bbox_inches='tight',pad_inches = 1)  #to save an image containing all the outputs
img_color = cv2.imread(output_path+'chebyshev_bio.png', 1)  # 1: Color image. 1 is optional.
